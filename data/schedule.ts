...
// DECIDED 2026-08-13: Day 5 = 집중 빌드·LAP Time 공유·즉석 인기 투표(빌더스
  ...
  },
  {
    ...
    runOfShow: [
      ...
      // 트랙 1은 12:50에 열려 1:30PM에 닫히고(발표 종료 12:59, 점심 시간에 걸침),
      // 트랙 2는 2:50에 열려 3:20PM에 닫힙니다(발표 종료 3:04, 간담회 시작에 맞춤).
      // 각 트랙을 발표 직후에 닫는 이유는 기억입니다 — 트랙 2를 두 시간 보고 나서
      // 트랙 1을 뽑으면 마지막에 본 것이 이깁니다.
      // 집계는 3:20부터 어워드(4:20PM)까지 한 시간입니다(간담회가 도는 동안).
      //
