...
// SMU도 워드마크만 씁니다(FOUNDRY와 같은 이유 — 스크립트 JOBS 주석 참고).
// 공식 로크업은 지도와 사자가 워드마크 위에 얹힌 세로 형태라, 마커 높이(16px)에
// 맞추면 글자가 5px도 되지 않습니다.
const VENUE_SMU = { src: "/partners/logos/white/trimmed/smu.png", name: "SMU" };
