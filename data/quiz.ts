...
export const RESULTS: Record<MbtiKey, Result> = {
  INTJ: {
    ...
    whyModel: { ko: "GPT-4급 모델을 약 558만 달러에 학습했어요. 미국의 20분의 1 비용이죠. 671B 중 37B만 켜는 MoE로, 조용히 극한의 효율을 뽑아내요.", en: "It trained a GPT-4-class model for ~$5.58M, about a twentieth of the US cost, firing just 37B of 671B params via MoE. Quiet, extreme efficiency." },
  ...
  INFJ: {
    ...
    match: ["ENTP", "ENFP"],
    matchWhy: [
      { ko: "당신이 원칙 지키느라 못 하는 말, 얘는 이미 하고 있어요. 대신 수습은 당신 몫이고, 그래서 완벽한 콤비죠 🤝", en: "The thing you won't say because you're keeping the principles, this one's already blurted out. Cleanup's on you, which is exactly why it works 🤝" },
  ...
  INFP: {
    ...
    desc: { ko: "캐릭터와 서사에 진심인 몰입러. 정답보다 감정선을 먼저 읽고, 이야기 속에서 마음을 나누는 이상주의자예요.", en: "A world-builder who lives in character and story, reading the feeling before the facts and connecting through the narrative." },
  ...
  ISTJ: {
    ...
    strengths: { ko: "검색·인용·신뢰도, 거짓말 안 함", en: "Search, citation, reliability, and never bluffs" },
  ...
  ESTJ: {
    ...
    whyModel: { ko: "소비자용 제품이 아예 없는 B2B 전용이에요. 프로덕션급 신뢰성과 컴플라이언스로 조직을 굴리는 경영자죠.", en: "B2B-only, with no consumer product at all, running on production-grade reliability and compliance." },
  ...
  ESFJ: {
    ...
    phrase: { ko: "부르지 않아도, 이미 옆에 와 있어요.", en: "You didn't call, but I'm already here." },
    desc: { ko: "Word·Excel·Teams 어디에나 스며든 서비스형 도우미. 굳이 찾아가지 않아도 필요한 자리에 먼저 나타나는 살뜰한 집정관이에요.", en: "A service-shaped helper woven into Word, Excel, and Teams, showing up where you need it before you go looking." },
  ...
  ISTP: {
    ...
    desc: { ko: "클라우드 없이 로컬에서 모델을 직접 뜯어 굴리는 해커. 설명서보단 손으로, 실전으로 문제를 푸는 메이커예요.", en: "A hacker who runs models locally, hands-on, solving by tinkering rather than reading the manual." },
...
export const quizUI = {
  ...
  subtitle: {
    ...
    en: "14 questions reveal your builder type, and your result is one of 16 AI models.",
  },
