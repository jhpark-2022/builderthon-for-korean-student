...
// ─────────────────────────────────────────────────────────────────────────────
// 본문 글자 단계 (DECIDED 2026-09-20, 표현 방식 브리프 7장)
//
// 넷뿐입니다. 루트가 18px이라 rem 값과 px 값이 어긋나므로 실제 px을 함께 적습니다.
//
//   text-[0.68rem]  12.24px  주석·캡션·라벨. 이 페이지의 하한입니다.
//   text-xs         13.5px   보조 본문
//   text-sm         15.75px  본문
//   text-base       18px     강조 문단
//
// 전에는 데스크톱 본문에 열네 단이 쓰이고 있었습니다(10 · 11 · 12 · 12.5 · 12.6 ·
// 13 · 13.5 · 15 · 15.75 · 18 · 20.25 …). 단이 많으면 크기 차이가 위계를 나타내지
// 못합니다. 10과 11은 12.24로 올렸고(접근성 하한이기도 합니다. app/globals.css의
// .naru-min12 규칙), 12·12.5·12.6·13은 13.5로, 15는 15.75로, 20.25는 18로
// 흡수했습니다.
//
// 제목 계열(H2 · H3 · ROW_HEADING · LABEL_HEADING · STATEMENT · 히어로 clamp)과
// 큰 숫자(카운트다운·스탯)는 이 넷에 들어가지 않습니다. 본문이 아니라 판의
// 뼈대라서, 본문 단계와 섞이면 둘 다 뜻을 잃습니다.
// ─────────────────────────────────────────────────────────────────────────────
