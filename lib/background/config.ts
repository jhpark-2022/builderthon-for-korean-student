...
export const SEOUL_WATERMARK = {
  ...
  stages: {
    ...
    // 보여야 함): { startVh: 0.5, spanVh: 1.5 } → { 1.2, 1.0 }. 전에는 #naru 상단 0.5화면
    // 앞에서 시작해 1화면 뒤에 끝나서, #naru 로고가 보일 때 건너기가 10%였습니다. 이제
    // #gains를 읽는 동안 건너고 #naru 상단 0.2화면 앞에서 끝납니다. 끝을 앞당기면서 길이를
    // 1.0화면으로 줄인 이유는 구간 2(서울)입니다. startVh 1.7 / span 1.5로 같은 끝을 만들면
    // 1920×1080에서 서울이 설 자리가 1.31화면이라 warnShortSeoul 기준(1.6)에 못 미칩니다.
    // 1.0화면이면 1920×1080 1.81, 1440×1100 1.75, 1440×900 3.01, 폰 4.4화면입니다.
    morph: { startVh: 1.2, spanVh: 1.0 },
