...
void main(){
  ...
  if (deep > 0.001) {
    ...
    // (0.5)로 올라가 그 둘레에 서울이 섭니다.
    // DECIDED 2026-09-23 (사용자: "퍼지는 효과가 싱가폴 쪽에서 너무 부족하다"): 건너는 동안
    // 0.70까지 올라가던 것(9/18의 끝 자리)을 뺍니다. 싱가포르도 화면 가운데(0.5)에 서는데
    ...
    // DECIDED 2026-09-23 (싱가포르 빛 속도 브리프): 폭은 config.ts의 LIGHT_SWEEP입니다.
    // DECIDED 2026-09-24 (폰 빛 움직임 브리프 2.1): 경로 계산을 BackgroundScene으로 옮겼습니다.
