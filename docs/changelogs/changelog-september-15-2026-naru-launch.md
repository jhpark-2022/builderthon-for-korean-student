...
| 멘토 | `dict.mentoring.mentors` | 11명. 사진, 이름, 소속, 직함, 소개 한 줄, 단계 칩, **링크드인** |
| 연사와 피드백 패널 | `dict.speakers.people` · `dict.speakers.panel` · `dict.judges.people` | 연사 3(세션 제목과 무슨 이야기였는지 불릿), Day 8 간담회 3, 피드백 패널 8(태그와 약력). 전부 사진과 **링크드인** |
