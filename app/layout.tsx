...
// 2026-09-24: 기간이 12/18~12/22로 옮겨졌습니다(lib/naruDates.ts의 DECIDED 주석).
...
const SITE_DESCRIPTION =
  `${DECEMBER_EVENT_NAME?.ko ?? "크로싱 서울"} 2026년 12월 18~22일, 서울. 한국의 대학생과 해외의 한인 유학생이 데이터에서 문제를 찾아 앞에서 증명하는 닷새입니다. 나루는 싱가포르에서 시작한 한인 학생 빌더 커뮤니티입니다.`;
...
const OG_TITLE = `${DECEMBER_EVENT_NAME?.ko ?? "크로싱 서울"} · 2026년 12월 18~22일 서울`;
