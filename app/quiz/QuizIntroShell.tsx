...
//
// LOCALE: copy is the English side on purpose. LocaleProvider also starts at
// "en" and only restores a saved Korean preference after mount, so this matches
// the app's own first client render; using Korean here would introduce a flash
    ...
    <main className="relative min-h-screen overflow-hidden bg-[#06040f] text-white">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-2xl flex-col px-6 pb-12">
        ...
        <div className="flex flex-1 flex-col items-center justify-center text-center">
          ...
          <p className="mt-5 text-xs font-medium text-white/40">{quizUI.meta.en}</p>
        </div>
      </div>
    </main>
  );
